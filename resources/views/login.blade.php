            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                   ...
                   <form action="{{route('login')}}" method="post">
                    ...
                    @endif
                    <label for="register" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">D'ont have an account <a href="{{route('register_form')}}" class="text-blue-600 hover:underline dark:text-blue-500">Create one</a></label>
                </div>
            </form>
            </div>
        </div>
