    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <label for="register" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">already have an account <a href="{{route('login_form')}}" class="text-blue-600 hover:underline dark:text-blue-500">LOG IN</a></label>
            </div>
        </div>
    </div>
</div>
